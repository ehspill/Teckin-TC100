...
#define DEFAULT_MAIN_KBPS           2048
#define DEFAULT_SUB_KBPS            512
...
char ac_option_hint[  ][ LEN_HINT ] = {
	...
	"[NUM]  ( DEFAULT: 25 )" ,
	"[NUM]  ( DEFAULT: 25 )" ,
	"[0|1]  BR_MODE_CBR: 0 | BR_MODE_VBR: 1( DEFAULT: 0 )" ,
	"[0|1]  BR_MODE_CBR: 0 | BR_MODE_VBR: 1( DEFAULT: 0 )" ,
...
struct option option_long[ ] = {
	...
	{ "sub-height"       , required_argument , NULL , 'd' } ,                                   //"[NUM]  ( DEFAULT: 480 )" ,
	{ "main-kbps"        , required_argument , NULL , 'e' } ,                                   //"[NUM]  ( DEFAULT: 2048 )" ,
	{ "sub-kbps"         , required_argument , NULL , 'f' } ,                                   //"[NUM]  ( DEFAULT: 512 )" ,
